...
from basicsr.archs.propainter.flow_loss_utils import flow_warp, ternary_loss2
...
def ternary_loss(flow_comp, flow_gt, current_frame, shift_frame, scale_factor=1):
    if scale_factor != 1:
    ...
    loss = ternary_loss2(current_frame, warped_comp_sc, noc_mask)
    return loss
